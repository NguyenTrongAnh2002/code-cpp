...
public:
    void nhap()
    {
        ...
        cout << " nhapso nhan vien: ";
        cin >> phong.sonv;
    }
    void xuat()
    {
        cout << left << setw(10) << maNV << setw(15) << hoDEM << setw(10) << ten << setw(1) << ngaysinh.d << "/" << ngaysinh.m << "/" << ngaysinh.y << setw(15) << phong.maPB << setw(15) << phong.tenPB << setw(15) << phong.truongphong << endl;
    }
    friend void xuattaichinh(NHANVIEN *nv, int n);
...
{
    cout << left << setw(10) << "maNV" << setw(15) << "hoDEM" << setw(10) << "ten" << setw(15) << "ngay sinh" << setw(15) << "maPB" << setw(15) << "tenPB" << setw(15) << "truongphong" << endl;
    for (int i = 0; i < n; i++)
    {
        nv[i].xuat();
    }
